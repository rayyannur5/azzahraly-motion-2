      ...
      <>
        <div className="flex flex-col  w-[calc(100vw-20svw)] h-screen bg-gradient-to-br from-cyan-500 to-sky-950 ">
          ...
          <div className="border-2 border-black h-[8vh] p-2 flex justify-between items-center">
            <div className="font-bold italic text-xl border-2 border-black">
              Azzahraly Motion
            </div>
          ...
          <div className="flex flex-row">
            <div className="w-[23vw] h-[84vh] border-2 border-black flex flex-col p-2 gap-2">
              ...
              {this.state.data.motions.map((motion, index) => (
                <button
                  key={index}
                  className={`btn  w-full ${this.state.activeMotion == index ? "bg-blue-400 hover:bg-blue-500" : ""}`}
            ...
            <div className="w-[23vw] h-[84vh] border-2 border-black flex flex-col p-2 gap-2">
              ...
              <div className="flex gap-2 justify-center">
                <button className="btn" onClick={this.handlerNewStep}>
                  New
                </button>
                <button className="btn" onClick={this.handlerDeleteStep}>
                  Delete
                </button>
              </div>
              {this.state.activeMotion != null ? (
                this.state.data.motions[this.state.activeMotion].steps.map(
                  (step, index) => (
                    <div className="flex gap-2" key={index}>
                      <button
                        className={`btn ${this.state.activeStep == index ? "bg-blue-400 hover:bg-blue-500" : ""}`}
          ...
          <div className="modal-box">
            ...
            <div className="modal-action">
              <form method="dialog">
                ...
                <button className="btn me-2" onClick={this.saveNewMotion}>
                  Save
                </button>
